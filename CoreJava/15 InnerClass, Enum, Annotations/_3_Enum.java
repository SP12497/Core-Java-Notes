...
// enum Mobile extends Enum //enum by default extends Enum Class so we can not
// multiple Inherit with it.
// enum Mobile extends CA //Error , multiple Inheritance not allowed
// enum Mobile implements IA // Allows
enum Mobile {
	Apple, Samsung(200), Realme; // These are the objects //Mobile constructor is called for all objects // by
